#!/usr/bin/env bash
# board.py — launcher for the org engine (the Koda runtime). Portable on purpose: no absolute /Users path.
...
E="${KODA_ENGINE:-$HOME/claudeking.cloud}"; T="$E/agents/scripts/board.py"
